...
public class FortuneWheelManager : MonoBehaviour
{
	...
	public int TurnCost = 500;					// How much coins user waste when turn whe wheel
	...
	private void Awake ()
	{
		_currentCoinsAmount = PlayerPrefs.GetInt("currency");
	...
	{
		PlayerPrefs.SetInt("currency", _currentCoinsAmount);
	...
	/// <summary>
	/// Sample callback for giving reward
	/// </summary>
